//key
//0d7b7e9e85015b6206aa086d2900fa49
//Secret
//7459087dd54efcd5ded90522979a9a04e3afd27a239aee8f57322455cf7a3595
        ...
        (function(c, g, a) {
            ...
            f = {
                ...
                rest: function() {
                    ...
                    g.support.cors || (a.dataType = "jsonp", "GET" !== c && (a.type = "GET", g.extend(a.data, {
                        _method: c
                    })));
                    k && (a.data.key = k);
                    e && (a.data.token = e);
            ...
            c.Trello = f;
            j = function(b) {
                return h + "/" + p + "/authorize?" + g.param(g.extend({
                    response_type: "token",
                    key: k
                }, b))
            };
